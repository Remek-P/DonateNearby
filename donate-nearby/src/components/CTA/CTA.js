        ...
        <section className="cta" id="cta">
            ...
            <ul className="cta-steps">
                <li className="cta-steps-li cta-steps-li-icon1">
                    ...
                    <p className="cta-steps-li__description">ubrania, zabawki,<br/> sprzęt i inne</p>
                </li>
                <li className="cta-steps-li cta-steps-li-icon2">
                    <h5 className="cta-steps-li__header">Spakuj je</h5>
                    <p className="cta-steps-li__description">skorzystaj z<br/> worków na śmieci</p>
                </li>
                <li className="cta-steps-li cta-steps-li-icon3">
                    <h5 className="cta-steps-li__header">Zdecyduj komu<br/> chcesz pomóc</h5>
                    <p className="cta-steps-li__description">wybierz zaufane<br/> miejsce</p>
                </li>
                <li className="cta-steps-li cta-steps-li-icon4">
                    <h5 className="cta-steps-li__header">Zamów kuriera</h5>
                    <p className="cta-steps-li__description">kurier przyjedzie<br/> w dogodnym terminie</p>
                </li>
            </ul>
